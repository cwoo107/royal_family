class ReferencesController < ApplicationController
  ...
  private
    ...
    def reference_params
      params.require(:reference).permit(:high, :school, :date1, :college, :major, :date2, :reference1, :ref1_addr, :ref1_phone, :reference2, :ref2_addr, :ref2_phone, :reference3, :ref3_addr, :ref3_phone, :user_id)
    end
end
